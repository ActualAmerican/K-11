...
static func tabs_templates() -> Dictionary:
	return {
		CaseEngineTypes.TAB_TIMELINE: [
			...
			{"tab":CaseEngineTypes.TAB_TIMELINE,"template_id":"timeline_note","fact_type":CaseEngineTypes.FACT_TIMELINE_NOTE,"text_tpl":"Maintenance note from {coworker_name} places the subject near {location}.","slot_keys":["coworker_name","location"],"truth_refs":["facts.coworker_name","facts.location"],"anchor":CaseEngineTypes.ANCHOR_TIMELINE,"reliability":CaseEngineTypes.RELIABILITY_SHAKY,"conflict_group":"timeline_window"},
			{"tab":CaseEngineTypes.TAB_TIMELINE,"template_id":"timeline_note_shift","fact_type":CaseEngineTypes.FACT_TIMELINE_NOTE,"text_tpl":"Shift handoff note records {coworker_name} clearing the subject through {location}.","slot_keys":["coworker_name","location"],"truth_refs":["facts.coworker_name","facts.location"],"anchor":CaseEngineTypes.ANCHOR_TIMELINE,"reliability":CaseEngineTypes.RELIABILITY_SHAKY,"conflict_group":"timeline_window"},
		],
		CaseEngineTypes.TAB_ALIBI: [
			...
			{"tab":CaseEngineTypes.TAB_ALIBI,"template_id":"alibi_witness","fact_type":CaseEngineTypes.FACT_ALIBI_WITNESS,"text_tpl":"{witness_name} references a meeting at {alibi_place}.","slot_keys":["witness_name","alibi_place"],"truth_refs":["alibi_truth","facts.witness_name"],"anchor":CaseEngineTypes.ANCHOR_ALIBI,"reliability":CaseEngineTypes.RELIABILITY_SHAKY,"conflict_group":"alibi_presence"},
			{"tab":CaseEngineTypes.TAB_ALIBI,"template_id":"alibi_witness_dispatch","fact_type":CaseEngineTypes.FACT_ALIBI_WITNESS,"text_tpl":"{witness_name} logs the subject near {alibi_place} before the shift break.","slot_keys":["witness_name","alibi_place"],"truth_refs":["facts.witness_name","facts.alibi_place"],"anchor":CaseEngineTypes.ANCHOR_ALIBI,"reliability":CaseEngineTypes.RELIABILITY_SHAKY,"conflict_group":"alibi_presence"},
		],
		CaseEngineTypes.TAB_CAPABILITY: [
			{"tab":CaseEngineTypes.TAB_CAPABILITY,"template_id":"capability_access","fact_type":CaseEngineTypes.FACT_CAPABILITY_ACCESS,"text_tpl":"{supervisor_name} signed off on access to the {tool}.","slot_keys":["supervisor_name","tool"],"truth_refs":["crime_type","facts.supervisor_name"],"anchor":CaseEngineTypes.ANCHOR_CAPABILITY,"reliability":CaseEngineTypes.RELIABILITY_SOLID,"conflict_group":"capability_scope"},
			{"tab":CaseEngineTypes.TAB_CAPABILITY,"template_id":"capability_access_badge","fact_type":CaseEngineTypes.FACT_CAPABILITY_ACCESS,"text_tpl":"Access records list the subject as cleared to handle the {tool} under {supervisor_name}.","slot_keys":["tool","supervisor_name"],"truth_refs":["crime_family","facts.tool","facts.supervisor_name"],"anchor":CaseEngineTypes.ANCHOR_CAPABILITY,"reliability":CaseEngineTypes.RELIABILITY_SOLID,"conflict_group":"capability_scope"},
			{"tab":CaseEngineTypes.TAB_CAPABILITY,"template_id":"capability_training","fact_type":CaseEngineTypes.FACT_CAPABILITY_TRAINING,"text_tpl":"Training ledger shows recent certification on {tool}.","slot_keys":["tool"],"truth_refs":["crime_family","facts.tool"],"anchor":CaseEngineTypes.ANCHOR_CAPABILITY,"reliability":CaseEngineTypes.RELIABILITY_SHAKY,"conflict_group":"capability_scope"},
			{"tab":CaseEngineTypes.TAB_CAPABILITY,"template_id":"capability_training_log","fact_type":CaseEngineTypes.FACT_CAPABILITY_TRAINING,"text_tpl":"Operations file notes a refresher block on {tool} procedures.","slot_keys":["tool"],"truth_refs":["facts.tool"],"anchor":CaseEngineTypes.ANCHOR_CAPABILITY,"reliability":CaseEngineTypes.RELIABILITY_SHAKY,"conflict_group":"capability_scope"},
		],
